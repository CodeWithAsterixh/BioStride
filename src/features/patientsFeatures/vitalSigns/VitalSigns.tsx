    ...
    <>
       {/* {person.YearlyData.year.map} */}
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-2 xl:gap-4 pt-3">
            <div className="bg-[#00b2cb] p-4 lg:p-2 xl:p-4 rounded-lg bg-opacity-30 shadow-sm flex flex-col justify-between gap-3">
            ...
            <div className="bg-[#ff5d00] p-4 lg:p-2 xl:p-4 rounded-lg bg-opacity-20 shadow-sm flex flex-col justify-between gap-3">
            ...
            <div className="bg-red-500 pl-4 lg:p-2 xl:p-4 py-4 rounded-lg bg-opacity-20 shadow-sm flex flex-col justify-between gap-3">
